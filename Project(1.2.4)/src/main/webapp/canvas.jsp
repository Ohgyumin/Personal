			...
			<div class="container-fluid">
				<nav class="navbar navbar-expand-lg custom_nav-container pt-3">
					<a class="navbar-brand" href="index.jsp"> <img
						src="images/logo.png" alt="" /> <span> Brainwave </span>
					</a>
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						<ul class="navbar-nav ml-auto mr-2">
							...
							<li class="nav-item"><a class="nav-link" href="select.jsp">Coloring</a>
							</li>
							<li class="nav-item"><a class="nav-link" href="Canvas.jsp">Canvas</a>
							</li>
						</ul>
						<c:choose>
			...
			<div class="row">
				...
				<div style="width: 40%; float: right;">
					<div class="custom_heading-container">
						<h2>Palette(※색상,굵기,undo,redo미구현상태※)</h2>
					</div>
					<div>
						<input type="text" id="rgb" class="form-control demo minicolors-input" data-format="rgb" value="rgb(0, 0, 0)" size="20" data-opacity="1.00" style="height: 50px;"/>
						<input type="range" id="Range" min="0.1" max="10.0" value="2.5" step="0.1"/>
						<br>
						<button type="button" class="button" onclick="undo_last()">되돌아가기</button>
						<button type="button" class="button" onclick="redo_last()">앞으로가기</button>
						<button  type="button" class="button" onclick="clear_canvas()">지우기</button>
						<br>
						<div>
