    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-lg-4 offset-lg-2 col-md-5 offset-md-1">
          <h2 class="custom_heading" style="margin-bottom: 20px;">Sign In</h2>
          <a href="signUp.jsp" style="color: #FFFFFF;">>> Sign Up Now</a>
          <br>
          <form action="signin.do" method="post" style="margin-top: 20px;">
            <div>
