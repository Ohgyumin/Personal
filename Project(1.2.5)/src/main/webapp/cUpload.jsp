  ...
  <section class="about_section layout_padding mt-5">
    <div class="container">
      <div class="row">
        <div class="col-md-7">
          <div class="img-box">
            <img src="images/about-img.png" alt="" class="thumb"/>
          </div>
        </div>
        <div class="col-md-5">
          <div class="detail-box">
			...
			<form action="cUpload.do" name="upload" method="post" enctype="multipart/form-data">
            <div>
				<input type="file" class="hidden_input" id="imageSelector" name="fileUpload" accept="image/jpeg, image/jpg, image/png" required>
